...
- (void)updateYTLiteSectionWithEntry:(id)entry {
    ...
    YTSettingsSectionItem *support = [%c(YTSettingsSectionItem) itemWithTitle:LOC(@"OriginalProject") accessibilityIdentifier:@"YTLiteSectionItem" detailTextBlock:^NSString *() { return @"↗"; } selectBlock:^BOOL (YTSettingsCell *cell, NSUInteger arg1) {
        return [%c(YTUIUtils) openURL:[NSURL URLWithString:@"https://github.com/dayanch96/YTLite"]];
    }];
